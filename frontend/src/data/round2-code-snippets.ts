// Multi-language code snippets for all Round 2 questions
// Each question supports Python, C, C++, and Java

export const ROUND2_CODE_SNIPPETS: Record<number, Record<string, string>> = {
  1: {
...
public class Main {
  ...
  2: {
    ...
    while code > 0:
        digit = code % 10
        reversed_code = reversed_code * 10 + digit
        code = code / 10
    return original == reversed_cod
# Test
